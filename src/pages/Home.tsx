...
export const Home = () => {
    ...
    return (
        <div className="overflow-x-hidden">
            <div className="container bg-hero-pattern bg-top bg-cover w-full bg-bg-home mx-auto flex flex-col justify-center items-center h-screen relative px-4">
